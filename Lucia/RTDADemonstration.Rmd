...
```{r}
points12 <- read.csv("points12.csv")
...
```{r}
points13 <- read.csv("points13.csv")
...
```{r}
points21<- read.csv("points21.csv", header = FALSE)
...
```{r}
points400_1<- read.csv("points400_1.csv", header = FALSE)
